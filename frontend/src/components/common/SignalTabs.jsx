...
import { FaBalanceScale, FaColumns, FaExchangeAlt, FaSignal } from 'react-icons/fa';
                        ...
                        <div className="max-w-4xl mx-auto bg-white dark:bg-gray-900 border-0 dark:border dark:border-gray-600 shadow-md rounded-lg">
                            ...
                            <div>
                                {chartDataOriginal && chartDataProcessed ? (
                                    <ComparisonChart table1={chartDataOriginal} table2={chartDataProcessed} name2={rightTitle} />
                                ) : (
                ...
                <Tabs color="indigo" variant="pills" defaultValue="dual" className='mt-2'>
                    ...
                    <Tabs.Panel value="comparison" pt="md">
                        <div className="max-w-4xl mx-auto bg-white dark:bg-gray-900 border-0 dark:border dark:border-gray-600 shadow-md rounded-lg">
                            ...
                            <div>
                                {chartDataOriginal && chartDataProcessed ? (
                                    <ComparisonSpectrumChart table1={chartDataOriginal} table2={chartDataProcessed} samplingRate={samplingRate} name2={rightTitle} />
                                ) : (
                                    <LoaderMessage message="Rendering comparison..." />
                                )}
                            </div>
